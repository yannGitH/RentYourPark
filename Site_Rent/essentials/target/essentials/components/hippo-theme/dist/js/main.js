...
(function () {
   ...
   *
   * @scope
   * @param {Array} markers A list of objects with a 'latitude' and 'longitude' property.
   */
    .directive('hippoMap', [
      function () {
        return {
          ...
          link: function (scope, elem) {
            ...
            if (angular.isArray(scope.markers)) {
              ...
              console.warn("map markers are not an array, but:", scope.markers);
            }

            function watchMarkers () {
              scope.$watch('markers', function (markers) {
                var latLngList = markers.map(function (marker) {
